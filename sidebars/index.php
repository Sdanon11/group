...
<main>
  ...
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-light" style="width: 280px;">
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      ...
      <span class="fs-5 fw-semibold" style="color: black;">หลังร้าน I Don't Have CPU</span>
    </a>
    <ul class="list-unstyled ps-0">
      <li class="mb-1">
        ...
        <div class="collapse show" id="home-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="update.php" class="link-dark rounded">เพิ่มสินค้า</a></li>
      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="dashboard-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="แสดงข้อมูลประเภทสินค้า.php" class="link-dark rounded">แสดงข้อมูลประเภทสินค้า</a></li>
      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="orders-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="3.php" class="link-dark rounded">แสดงข้อมูลลูกค้า</a></li>
      ...
      <li class="mb-1">
        ...
        <div class="collapse" id="orders-collapse">
          <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
            <li><a href="view_order.php" class="link-dark rounded">แสดงรายการสั่งซื้อ</a></li>
...
<body>
 <div class="b-example-divider b-example-vr"></div>
  ...
  <div class="d-flex flex-column align-items-stretch flex-shrink-0 bg-body-tertiary" style="width: 80%;">
    <a href="/" class="d-flex align-items-center flex-shrink-0 p-3 link-body-emphasis text-decoration-none border-bottom">
      
    </a>
    <div class="list-group list-group-flush border-bottom scrollarea">
      <div class="list-group-item list-group-item-action active py-3 lh-sm" aria-current="true">
        <strong class="mb-1">แสดงข้อมูลสินค้าทั้งหมด</strong>
        <div class="container border">        
          <table id="myTable" class="table table-striped table-hover" style="width:100%">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  <td><button class="btn btn-info btn-sm" onclick="location.href='insert.php?pid=<?=$data['p_id'];?>'"><i class="bi bi-pencil-square"></i> แก้ไข</button></td>
                  <td>
    <button class="btn btn-danger btn-sm" onclick="location.href='delete.php?pid=<?= $data['p_id']; ?>'">
        <i class="bi bi-trash-fill"></i>ลบ
    </button>
</td>
                  <td><img src="<?=$img;?>" width="100" alt="<?=$data['p_name'];?>"></td>
                  <td><?=$data['p_name'];?></td>
                  <td><?=$data['p_detail'];?></td>
                  <td><?=$data['p_price'];?></td>
                  <td><?=$data['c_name'];?></td>
